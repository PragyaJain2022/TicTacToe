...
public class OrderOneWinningGameStrategy implements GameWinningStrategy {
    ...
    @Override
    public boolean checkIfWon(Board board, Player player, int row,int col,Cell moveCell) {
